...
import com.example.chatapp.chat.ChatItem
import com.example.chatapp.chat.ContactForm
...
class Messages : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rv_msg_list.adapter = ChatAdapter(this.requireContext(), chatItems){
    ...
    private fun initData(){
        ...
        for (i in name.indices){
            chatItems.add(ChatItem(name[i], shortMsg[0], image.getResourceId(0, 0), time[i]))
        }
    }
