...
import com.example.chatapp.view.ui.fragment.ContactItem

class ContactsFragmentAdapter(private val contex : Context, private val contactItems: List<ContactItem>, private val listener: (ContactItem) -> Unit)
    : RecyclerView.Adapter<ContactsFragmentAdapter.ViewHolder>() {
